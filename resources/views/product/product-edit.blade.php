                            ...
                            <form id="frmEditProduct">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtProductName" placeholder="Product Name"
                                            name="name" autocomplete="off" value="{{$product->name}}">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtMyanmarName" placeholder="မြန်မာနာမည်"
                                            name="myanmar_name" autocomplete="off" value="{{$product->myanmar_name}}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="txtProductCode" placeholder="Product Code"
                                            name="product_code" autocomplete="off" value="{{$product->product_code}}">
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <select name="measure_unit_id" class="form-control select2ProductMeasureUnit col-12" id="dlProductUnit">
                                            <option></option>
                                            <option value="{{$product->measure_unit->id}}" selected>{{$product->measure_unit->name}}</option>
                                        </select>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input type="number" class="form-control" id="txtExMillPrice" placeholder="Ex-mill Price" value="{{$product->ex_mill_price}}"
                                            name="ex_mill_price" autocomplete="off">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="txtTransportFee">Lorry Fee: </label>
                                        <input type="number" class="form-control" id="txtTransportFee" placeholder="Lorry Fee" value="{{$product->transport_fee}}"
                                            name="transport_fee" autocomplete="off">
                                    </div>

                                    <div class="form-group col-md-6">
                                        <label for="txtUnloadFee">Unload Fee: </label>
                                        <input type="number" class="form-control" id="txtUnloadFee" placeholder="Unload Fee" value="{{$product->unload_fee}}"
                                ...
                                <button type="button" class="btn btn-primary" id="btnUpdateProduct">Update Record</button>
...
@include('product.js_load.product-edit-js')
